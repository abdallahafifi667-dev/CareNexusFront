...
const DoctorDashboard = () => {
    ...
    const stats = [
        ...
        },
        {
            ...
            value: historyOrders?.filter((o) => o.status === "completed").length || 0,
            icon: CheckCircle,
            color: "green",
        },
        {
            title: t("doctor.stats.total_earnings", {
                defaultValue: "Total Earnings",
            }),
            value: historyOrders?.reduce((acc, curr) => acc + (curr.price || 0), 0) || 0,
            icon: TrendingUp,
            color: "purple",
            ...
            <div className="welcome-banner">
                <div className="banner-content">
                    <div className="banner-greeting">
                        ...
                        <p>
                            {t("doctor.dashboard_intro", {
                                defaultValue:
                                    "Manage your patients and orders efficiently today.",
                            })}
                        </p>
                        ...
                        <div className="banner-stats-preview">
                            <div className="mini-stat">
                                ...
                                <span className="value">{activeOrders?.length || 0}</span>
                            </div>
            ...
            <div className="dashboard-content">
                <div className="recent-activity">
                    <div className="section-header">
                        <h3>
                            {t("doctor.recent_alerts", { defaultValue: "Important Alerts" })}
                        </h3>
                    </div>
                        ...
                        {activeOrders?.length > 0 ? (
                            <div className="alert-item primary">
                                ...
                                <div className="alert-body">
                                    <p>
                                        {t("doctor.alerts.active_task", {
                                            count: activeOrders?.length || 0,
                                            defaultValue: `You have ${activeOrders?.length || 0} tasks in progress.`,
                                        })}
                                    </p>
                ...
                <div className="quick-actions">
                    ...
                    <div className="actions-grid">
                        ...
                        <button className="action-tile secondary">
                            <TrendingUp size={24} />
                            <span>
                                {t("doctor.stats.earnings", { defaultValue: "Earnings" })}
                            </span>
                        </button>
                    </div>
                </div>
