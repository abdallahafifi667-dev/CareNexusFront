...
const DoctorReviews = () => {
  ...
  const { reviews, reviewStats, loading, error } = useSelector(
    (state) => state.doctor,
  );
      ...
      <div className="stats-overview">
        <div className="stat-box">
          ...
          <div className="stat-content">
            ...
            <p>
              {t("doctor.average_rating", { defaultValue: "Average Rating" })}
            </p>
          </div>
        </div>
        <div className="stat-box">
          ...
          <div className="stat-content">
            ...
            <p>
              {t("doctor.total_reviews", { defaultValue: "Total Reviews" })}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="reviews-list">
        {error ? (
          ...
          <div className="empty-state">
            ...
            <h3>
              {t("doctor.no_reviews", { defaultValue: "No reviews yet" })}
            </h3>
            <p>
              {t("doctor.no_reviews_desc", {
                defaultValue: "Your patient feedback will appear here.",
              })}
            </p>
          </div>
        ) : (
            ...
            >
              ...
              <div className="review-footer">
                <span className="service-tag">
                  {t(`medical_service.${review.product?.medicalServiceType}`, {
                    defaultValue: review.product?.medicalServiceType,
                  })}
                </span>
              </div>
            </motion.div>
