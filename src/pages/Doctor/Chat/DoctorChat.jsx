                ...
                <div className="chat-main">
                    {activeChat ? (
                                ...
                                <div className="chat-partner-info">
                                    ...
                                    <div className="details">
                                        ...
                                        <span className="order-context">
                                            {t(
                                                `medical_service.${activeChat.order?.medicalServiceType}`,
                                                { defaultValue: activeChat.order?.medicalServiceType },
                                            )}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className="no-chat-selected">
                            ...
                            <h3>
                                {t("doctor.select_conversation", {
                                    defaultValue: "Select a conversation",
                                })}
                            </h3>
                            <p>
                                {t("doctor.select_conversation_desc", {
                                    defaultValue:
                                        "Choose a patient from the sidebar to view your message history and continue chatting.",
                                })}
                            </p>
                        </div>
                    )}
