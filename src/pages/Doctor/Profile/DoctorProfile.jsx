...
const DoctorProfile = () => {
  ...
  const handleSave = async () => {
    ...
    const cleanedDegrees = formData.academicDegrees.filter(
      (degree) =>
    ...
    >
      <div className="profile-layout-grid">
        ...
        <div className="main-column">
            ...
            <div className="header-content">
              ...
              <div className="identity-section">
                ...
                <p className="headline">
                  {user?.specialization ||
                    t("doctor.specialty_placeholder", "Medical Professional")}
                </p>
                ...
                <div className="connection-count">
                  <span className="count">
                    {user?.connectionsCount || (user?._count?.followers + user?._count?.following) || 0}
                  </span>
                  <span className="label text-muted">
                    {t("doctor.connections", "connections")}
                  </span>
                </div>
              </div>
            </div>
          ...
          >
            <p className="bio-text">
              {user?.description ||
                t(
                  "doctor.no_bio_yet",
                  "No bio provided yet. Add a short summary about your professional background.",
                )}
            </p>
          </ProfileCard>

          {/* Activity Card - Moved up for social prominence */}
          <section className="linkedin-card activity-section">
            <div className="card-header">
              <div className="header-left">
                <h3>{t("posts.activity", "Activity")}</h3>
                <span className="sub-header">
                  {user?._count?.followers || 0} {t("posts.followers", "followers")}
                </span>
              </div>
              <button
          ...
          <ProfileCard
            title={t("doctor.professional_details", "Professional Details")}
          ...
          >
            <div className="pro-info-grid">
              ...
              <div className="info-row">
                <ShieldCheck className="icon text-muted" size={24} />
                <div className="text">
                  <h4>{t("doctor.kyc_status")}</h4>
                  <p>
                    {user?.documentation
                      ? t("common.verified", "Verified")
                      : t("common.pending", "Pending Verification")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="education-list">
              {user?.academicDegrees?.length > 0 ? (
                user.academicDegrees.map((edu, idx) => (
                  <div key={idx} className="edu-item">
                    ...
                    <div className="edu-info">
                      ...
                      <p>
                        {t(`doctor.degree_${edu.degree}`, edu.degree)} •{" "}
                        {edu.field}
                      </p>
                ...
                <p className="text-muted">
                  {t("doctor.no_education_yet", "No academic degrees listed.")}
                </p>
              )}
            </div>
          </ProfileCard>
                        ...
                        <div key={idx} className="degree-row">
                          <div className="row-inputs">
                            ...
                            <input
                              ...
                              value={edu.field}
                              onChange={(e) =>
                                handleDegreeChange(idx, "field", e.target.value)
                              }
                            />
                            <input
