...
import PopupConfirm from "../../../../shared/components/common/PopupConfirm";
    ...
    try {
      await dispatch(
        handleOrderAction({
          ...
          orderId: order._id,
          data:
            pendingAction === "accept" ? { proposedPrice, description } : {},
        }),
      ).unwrap();
  ...
  return (
    <div className={`order-details-view ${isRtl ? "rtl" : ""}`}>
          ...
          <div className="patient-profile">
            ...
            <div className="profile-info">
              ...
              <p className="order-spec">
                {t(`medical_service.${order.medicalServiceType}`)} •{" "}
      ...
      <PopupConfirm
        ...
        title={t(`doctor.confirm.${pendingAction}_title`, {
          defaultValue: t("common.confirmation"),
        })}
        ...
        message={
          pendingAction === "accept" ? (
            ...
            t(`doctor.confirm.${pendingAction}_desc`, {
              defaultValue: t("common.are_you_sure"),
            })
          )
        }
      />
